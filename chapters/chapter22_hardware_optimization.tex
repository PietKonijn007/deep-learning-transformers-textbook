...
NVLink 5.0 & B200 (72 NVSwitch) & 1.8~TB/s & ${\sim}$1--2~$\mu$s & Multi-rack & Extended TP \\
ICI torus & TPU v5p pod & Multi-TB/s & ${\sim}$1--3~$\mu$s & Within pod & TP/EP \\
Infinity Fabric & MI300X (8 GPUs) & ${\sim}$896~GB/s & ${\sim}$2--3~$\mu$s & Intra-node & TP, EP \\
NeuronLink & Trn2 (16 chips) & ${\sim}$1.6~TB/s & ${\sim}$few~$\mu$s & Intra-inst & TP \\
InfiniBand NDR & Multi-node & 400~Gb/s/port & ${\sim}$5--10~$\mu$s & Cross-node & PP, param sync \\
