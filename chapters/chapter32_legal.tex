...
\item ROI: 2.5:1 in year one; ongoing 5:1
\end{itemize}
...
\textbf{Cost management and ROI tracking.} Legal AI is expensive: \$500K-5M development, \$200K-1M annual operations for large-scale systems. Track ROI carefully: lawyer time savings, increased throughput, improved quality, reduced errors. Ensure ROI justifies ongoing investment. If ROI turns negative due to drift or low adoption, consider sunsetting.

Budget example: Law firm with 100 lawyers. Contract review system costs \$1M development, \$300K annual operations. System saves 30 minutes per contract, 20 contracts per lawyer per year = 1,000 hours saved. At \$300/hour, savings = \$300K annually. ROI: (300K - 300K) / (1M + 300K) = 0 in year one, but 100% in subsequent years. Payback period: 13 months.
